...
* Project     = Cloud
*
* Description = Dashboard Cloud Use Class
*****************************************************************************/
...
/// <summary>
/// Proxy Class for Dashboard Team
/// </summary>
public class DashboardCloudProxy {
    Cloud cloudService;
    string containerName = "dashboard";   /// specific container details
    string _sasToken = "";  /// SAS Token for authentication

    /// <summary>
    /// Set up cloud service
    /// </summary>
    public DashboardCloudProxy() {
